...
dir.create(here(fig6 <-
                  here("Figure-6")), recursive = TRUE) 
...
# Preprocessing plots
prepro.plots(data = ins, output_dir = fig6)
...
write.csv(all_markers_pct, file = here(fig6, "all_markers_pct.csv"))
...
write.csv(top50_markers_pct, file = here(fig6, "top50_markers_pct.csv"))
...
# Create_Cluster_Annotation_File(file_path = fig6, file_name = "cluster_annotation")

annotation_info <- Pull_Cluster_Annotation(annotation = here(fig6,"cluster_annotation.csv"))
...
write.csv(all_markers_pct, file = here(fig6, "all_markers_pct_annot.csv"))
...
write.csv(top50_markers_pct, file = here(fig6, "top50_markers_pct_annot.csv"))
...
saveRDS(obj_annot, file = paste0(fig6,"/annot_ins.Rds"))
