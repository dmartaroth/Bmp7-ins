...
ins <- readRDS(here(fig6,"/annot_ins.Rds"))
...
write.csv(top30,file=here(fig6,"/top30_Bmp7cells.csv"))
...
# Consider removing panels E and F from Figure 6 (not very informative)